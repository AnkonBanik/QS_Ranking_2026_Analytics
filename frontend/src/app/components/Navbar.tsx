...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 glass-card border-b border-gray-200 dark:border-gray-800/80 transition-colors">
        ...
        <div className="flex items-center justify-between h-16">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive
                      ? "bg-indigo-600/10 dark:bg-indigo-600/20 text-indigo-600 dark:text-indigo-400 border border-indigo-500/30 shadow-sm"
                      : "text-gray-600 dark:text-gray-300 hover:text-slate-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800/50"
                  }`}
                >
          ...
          <div className="flex items-center space-x-3">
            ...
            <a
              ...
              className="p-2.5 rounded-xl border transition-all flex items-center justify-center bg-gray-100 dark:bg-slate-900/90 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 hover:scale-105"
            ...
            <div className="hidden sm:flex items-center space-x-2 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 rounded-full">
              ...
              <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400">1,504 Universities</span>
            </div>
          </div>
        </div>
      </div>
